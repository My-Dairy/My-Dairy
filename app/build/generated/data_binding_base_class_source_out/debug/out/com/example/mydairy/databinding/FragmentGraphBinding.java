...
public final class FragmentGraphBinding implements ViewBinding {
  ...
  private FragmentGraphBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textGallery) {
  ...
  public static FragmentGraphBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentGraphBinding((ConstraintLayout) rootView, textGallery);
    }
