...
public final class ActivitySidebarBinding implements ViewBinding {
  @NonNull
  ...
  private ActivitySidebarBinding(@NonNull DrawerLayout rootView,
  ...
  @NonNull
  public static ActivitySidebarBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySidebarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_sidebar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySidebarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySidebarBinding((DrawerLayout) rootView, binding_appBarSidebar,
