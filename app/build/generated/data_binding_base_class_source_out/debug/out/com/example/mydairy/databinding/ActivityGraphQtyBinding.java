...
public final class ActivityGraphQtyBinding implements ViewBinding {
  ...
  private ActivityGraphQtyBinding(@NonNull ConstraintLayout rootView, @NonNull EditText endDteEdit,
  ...
  public static ActivityGraphQtyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGraphQtyBinding((ConstraintLayout) rootView, endDteEdit, endDteTxt,
